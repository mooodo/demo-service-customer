...
public class CustomerRepository extends AbstractRepository<Customer> {
	...
	protected void initialize() {
		Customer john = new Customer("0001","John","male",DateUtils.getDate("19820312", "yyyyMMdd"),
				"110120198203127712","13601327812");
		put(john);
		
		Customer jack = new Customer("0002","Jack","male",DateUtils.getDate("19820709", "yyyyMMdd"),
				"110120198207098819","13612128881");
		put(jack);
		
		Customer hanna = new Customer("0003","Hanna","female",DateUtils.getDate("19851209", "yyyyMMdd"),
				"110120198512092312","13633447899");
		put(hanna);
		
		Customer anna = new Customer("0004","Anna","female",DateUtils.getDate("19851109", "yyyyMMdd"),
